Feature: User visa registration feature
  ...
  Scenario Outline: I should be able to submit visa form
    ...
    Examples:
      ...
      | Isle of Man      | Mali                        | 2011-05-31  | Kraig    | Wiza      | Kraig@nobody.com   | 1-000-884-1373 | Dolorem consequatur rerum atque. |
      | Lithuania        | Mexico                      | 2001-01-01  | Houston  | Kertzmann | Houston@nobody.com | 284.864.6580   |                                  |
      | Somalia          | Greece                      | 2004-07-02  | Ruthie   | Stamm     | Ruthie@nobody.com  | 1-209-813-9712 | Dolorem consequatur rerum atque. |
